...
<html lang="en">
  ...
  <body>
        ...
        <aside id="side-nav-group">
          ...
          <main>
             <div class="sports-equipment">
                  <div class="div">
                  <div class="overlap">
                                <div class="navbar">
                                  <div class="text-wrapper">200</div>
                                  <div class="text-wrapper-1">90</div>
                                  <div class="text-wrapper-2">100</div>
                                  <div class="text-wrapper-3">10</div>
                                  <div class="text-wrapper-01">All Equipment</div>
                                  <div class="text-wrapper-02">Available</div>
                                  <div class="text-wrapper-03">Currently used</div>
                                  <div class="text-wrapper-04">Damage</div>
                                </div>
                                <p class="SKC-sports-equipment">
                                  <span class="span">SKC Sports Equipment <br /></span> <span class="text-wrapper-05">SORSU-BC</span>
                                </p>
                              </div>
                    <div class="overlap-2">
